...
public class ParseTriple {
    ...
    public String parseTriples(String subject, String object, String predicate, String truthValue) {
        String parsedTriple = "";
        parsedTriple = subject + "\t" + getSubjectRelation(subject, predicate) + "\t" + object + "\t" + getObjectRelation(object, predicate) 
                        + "\t" + getPredicate(predicate) + "\t" + truthValue;
        return parsedTriple;
    }

    public PreProcessedTriple preprocessTriple(String subject, String object, String predicate, String truth_value) {
    ...
    public static void readStrNodeFile() {
        if (str_nodes.isEmpty()) {
            String path = "./sample_data/gfc_str_nodes.tsv";
